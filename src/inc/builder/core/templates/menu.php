		...
		<ul class="ttfmake-menu-list">
			...
			<?php if ( ! ttfmake_is_plus() ) : ?>
				<li class="ttfmake-menu-list-item make-plus-products">
					<div class="ttfmake-menu-list-item-link-icon-wrapper clear" style="background-image: url('<?php echo addcslashes( esc_url_raw( get_template_directory_uri() . '/inc/builder/sections/css/images/post-list.png' ), '"' ); ?>');">
						<span class="ttfmake-menu-list-item-link-icon "></span>
					</div>
					<div class="section-type-description">
						<h4>
